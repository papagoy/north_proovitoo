...
<!DOCTYPE html>
<html ng-app="grading-app">
<head>
    <meta charset="utf-8">
    <title>Nortal University Test Assignment</title>
...
<body class="preview" id="top">
    ...
    <footer class="bs-docs-footer">
        <div class="container">
            <p>
                Created by Priit Liivak for Nortal test assignment.<br /> Editing of this application is only allowed with the purpose of applying to Nortal. We are not
                responsible for the content dynamically loaded or generated on this site and do not endorse the views expressed within that content.<br />
            </p>
            <p class="pull-right">
